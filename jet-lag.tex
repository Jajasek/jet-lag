...
(Originál 15mi: zábavní park, zoo, akvárium, linka metra)
...
Most
Lidmi vytvořená struktura vypadající nejvyšší z takové zastávky některého z povolených dopravních prostředků, která je schovávačovi v tomto okamžiku nejblíž
?
...
\begin{cards}
	\card{Kletba všímavého spotřebitele}[1] Hledači musí zakoupit produkt či získat vstup na lokaci, na niž viděli reklamu. Tato reklama musí být nalezena v \textbf{reálném světě} (nikoliv na digitálním zařízení hledače) a musí být od samotného produktu či lokace vzdálena alespoň 30m. Dokud není kletba splněna, hledači nesmí položit \textbf{žádnou otázku}.

		\cost následující otázka hledačů je zdarma.

	\card{Kletba nezkušeného cestovatele}[1] Hraj, pokud hledači právě necestují dopravním prostředkem. Urči libovolnou veřejně dostupnou lokaci vzdálenou nejvýše \dist.5mi od hledačů. Ti tam musí dojít a strávit tam alespoň \timecursetravelvisit/. \textbf{Až poté mohou položit další otázku.}
